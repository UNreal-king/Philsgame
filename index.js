   document.addEventListener("DOMContentLoaded", () => {
      ...
      function playGame(playerChoice){
        ...
        ){ result = "🔥 You Win!"; playerScore++; flash("win"); fireworks(); }
        else { result = "💀 You Lose!"; computerScore++; flash("lose"); shake(); }
